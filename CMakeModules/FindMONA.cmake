...
if(MONA_USE_STATIC_LIBS)
	find_library(MONA_MEM_LIBRARY NAMES libmonamem.a)
	find_library(MONA_BDD_LIBRARY NAMES libmonabdd.a)
	find_library(MONA_DFA_LIBRARY NAMES libmonadfa.a)
	find_library(MONA_GTA_LIBRARY NAMES libmonagta.a)
else()
