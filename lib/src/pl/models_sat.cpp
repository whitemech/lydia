...
//    temp_clause.clear();
//    apply(*subformula);
//    cp_model.AddBoolOr(temp_clause);
//  }
//}
//
...
//}
//
// void SATSolverWrapper::apply(const PropositionalFormula &f) {
// f.accept(*this); }
//
// set_atoms_ptr
...
//    auto false_ = converter.cp_model.FalseVar();
//    converter.cp_model.AddBoolAnd({false_});
//  }
//  else if(is_a<PropositionalTrue>(f)) {
//    auto true_ = converter.cp_model.TrueVar();
//    converter.cp_model.AddBoolAnd({true_});
//  } else if (!is_a<PropositionalAnd>(f)) {
//    converter.cp_model.AddBoolAnd({});
//  }
