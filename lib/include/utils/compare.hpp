...
// inline bool unified_eq(const std::map<K, V, C> &a, const std::map<K, V, C>
// &b)
//{
//    return ordered_eq(a, b);
//}
...
//
////! eq function base
////! \return true if the two dictionaries `a` and `b` are equal. Otherwise
///false
// template <class T>
...
//
// template <typename T, typename U>
// inline int unified_compare(const std::pair<T, U> &a, const std::pair<T, U>
// &b)
//{
